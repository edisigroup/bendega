  ...
  return (
    <footer className="bg-white pt-12 pb-6 px-6 md:px-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div className="col-span-1">
          <h3 className="font-medium mb-4">Blogpost</h3>
          <ul className="space-y-2 text-sm text-gray-600">
            <li>
        ...
        <div className="col-span-1">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.2601070104856!2d115.22556687417054!3d-8.666795188206313!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd2408c4dfd9f85%3A0x2d0ee0e62af3d942!2sBendega%20Restaurant!5e0!3m2!1sen!2sid!4v1745166218827!5m2!1sen!2sid" width="300" height="260" allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>

      <div className="border-t border-gray-200 pt-6 text-center text-sm text-gray-500">
        <p>© 2024 Bendega Bali. All Rights Reserved</p>
      </div>
    </footer>
  )
}
